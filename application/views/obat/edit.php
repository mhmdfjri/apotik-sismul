        ...
        <div class="p-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded shadow overflow-hidden mb-6">
                    ...
                    <form id="editMedicineForm" class="p-6" action="<?= base_url('index.php/obat/update/' . $obat->id_obat) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        for="medicineName"
                                        class="block text-sm font-medium text-gray-700 mb-1">Nama Obat <span class="text-red-500">*</span></label>
                                    <input
                                        type="text"
                                        id="medicineName"
                                        name="name"
                                ...
                                <input type="hidden" name="old_image" value="<?= $obat->gambar_obat ?>">
                                ...
                                <div class="md:row-span-2">
                                    ...
                                    <div
                                        ...
                                        <!-- Jika tidak ada gambar, tampilkan prompt -->
                                        <div id="uploadPrompt" class="flex flex-col items-center <?= $obat->gambar_obat ? 'hidden' : '' ?>">
                                            <div class="w-12 h-12 flex items-center justify-center bg-gray-100 text-gray-400 rounded-full mb-2">
                                        ...
                                        <div
                                            ...
                                            class="<?= $obat->gambar_obat ? '' : 'hidden' ?> absolute inset-0 flex items-center justify-center">
                                            <img
                                                id="imagePreview"
                                                src="<?= base_url('uploads/' . $obat->gambar_obat) ?>"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        class="w-full px-4 py-2 border border-gray-200 rounded focus:ring-2 focus:ring-primary focus:border-primary outline-none transition"
                                        placeholder="Masukkan Deskripsi Obat"><?= $obat->deskripsi ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        ...
                                        class="block text-sm font-medium text-gray-700 mb-1">Kategori <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <select
                                            id="medicineCategory"
                                            name="category_id"
                                            ...
                                            <?php foreach ($categories as $category): ?>
                                                <option value="<?= $category->id_kategori ?>" <?= $category->id_kategori == $obat->id_kategori ? 'selected' : '' ?>>
                        ...
                        <div class="mb-8">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label
                                        for="medicineStock"
                                        class="block text-sm font-medium text-gray-700 mb-1">Kuantitas <span class="text-red-500">*</span></label>
                                    <div class="flex">
                                        <button
                                            type="button"
                                            id="decreaseStock"
                                ...
                                <div>
                                    <label
                                        for="medicinePrice"
                                        class="block text-sm font-medium text-gray-700 mb-1">Harga <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <div
                                ...
                                <div>
                                    <label
                                        for="medicineExpiry"
                                        class="block text-sm font-medium text-gray-700 mb-1">Expiration Date
                        ...
                        <!-- Form Actions -->
                        <div
                            class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-4 border-t border-gray-100">
                            <a
                                href=""
                                data-readdy="true"
