                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="medicineName" name="name"
                                        ...
                                        placeholder="Masukkan Nama Obat" value="<?= $obat->nama_obat ?>" required />
                                ...
                                <div class="md:row-span-2">
                                    ...
                                    <div id="imageDropzone"
                                        ...
                                        <div id="uploadPrompt"
                                            class="flex flex-col items-center <?= $obat->gambar_obat ? 'hidden' : '' ?>">
                                            <div
                                        ...
                                        <div id="imagePreviewContainer"
                                            ...
                                            <img id="imagePreview"
                                                ...
                                                alt="Medicine preview" class="max-h-full max-w-full object-contain" />
                                    ...
                                    <div class="relative">
                                        <select id="medicineCategory" name="category_id"
                                            ...
                                            <option value="<?= $category->id_kategori ?>"
                                                <?= $category->id_kategori == $obat->id_kategori ? 'selected' : '' ?>>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="medicinePrice" name="price" min="0.01" step="0.01"
                                            ...
                                            placeholder="0.00" value="<?= $obat->harga ?>" required />
                                    </div>
                                    <div class="hidden error-message text-red-500 text-xs mt-1">
